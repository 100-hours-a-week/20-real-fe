...
// --- Icons ---
import { BoldIcon } from '@/widgets/tiptap-editor/tiptap-icons/bold-icon';
import { Code2Icon } from '@/widgets/tiptap-editor/tiptap-icons/code2-icon';
import { ItalicIcon } from '@/widgets/tiptap-editor/tiptap-icons/italic-icon';
import { StrikeIcon } from '@/widgets/tiptap-editor/tiptap-icons/strike-icon';
import { UnderlineIcon } from '@/widgets/tiptap-editor/tiptap-icons/underline-icon';
// --- UI Primitives ---
