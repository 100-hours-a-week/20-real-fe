...
import { HeadingFiveIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-five-icon';
import { HeadingFourIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-four-icon';
// --- Icons ---
import { HeadingOneIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-one-icon';
import { HeadingSixIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-six-icon';
import { HeadingThreeIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-three-icon';
import { HeadingTwoIcon } from '@/widgets/tiptap-editor/tiptap-icons/heading-two-icon';
// --- UI Primitives ---
