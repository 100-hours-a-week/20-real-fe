...
export function LoadingIndicator({ loadingRef, hasNextPage, isFetchingNextPage, isLoading, ...rest }: LoadingIndicatorProps) {
  const shouldShow = (isLoading) || (hasNextPage && isFetchingNextPage);
